...
SELECT Scientists.Name AS ScientistName, Projects.Name AS ProjectName FROM Scientists 
...
SELECT Scientists.Name AS ScientistName, Projects.Name AS ProjectName, Projects.Hours AS HoursWorked FROM Scientists 
INNER JOIN AssignedTo ON Scientists.SSN = AssignedTo.Scientist 
INNER JOIN Projects ON AssignedTo.Project = Projects.Code;
